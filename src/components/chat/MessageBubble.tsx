...
export function MessageBubble({ message }: { message: ChatMessage }) {
  ...
  const showImage = isImageType || !!message.imageUrl;
        ...
        {showImage && (
          <div className="mb-2">
            {message.imageUrl ? (
              ...
              <div className="w-48 h-48 rounded-lg bg-gray-50 flex flex-col items-center justify-center gap-2">
                <div className="w-8 h-8 rounded-full bg-pink-50 flex items-center justify-center animate-pulse">
                ...
                <span className="text-gray-400 text-xs">图片生成中...</span>
              </div>
            )}
          </div>
        )}
